<script lang="ts">
	...
	type ActionName = "dance" | "fall" | "idle" | "jump" | "running" | "tpose" | "walk";
	type GLTFResult = {
		nodes: {
			mixamorigArms_Geo: THREE.SkinnedMesh;
			mixamorigCigar_Geo: THREE.SkinnedMesh;
			mixamorigHat_Geo: THREE.SkinnedMesh;
			mixamorigHead_Geo: THREE.SkinnedMesh;
			mixamorigJacket_Geo: THREE.SkinnedMesh;
			mixamorigL_Eye_Geo: THREE.SkinnedMesh;
			mixamorigPants_Geo: THREE.SkinnedMesh;
			mixamorigR_Eye_Geo: THREE.SkinnedMesh;
			mixamorigShoes_Geo: THREE.SkinnedMesh;
			mixamorigTeeth_Down_Geo: THREE.SkinnedMesh;
			mixamorigTeeth_Up_Geo: THREE.SkinnedMesh;
			mixamorigHips: THREE.Bone;
		};
		materials: {
			Skin_MAT: THREE.MeshStandardMaterial;
			Cigar_Mat: THREE.MeshStandardMaterial;
			["Clothes_MAT.001"]: THREE.MeshStandardMaterial;
			["Eyes_MAT.001"]: THREE.MeshStandardMaterial;
		};
	};

	const gltf = suspend(useGltf<GLTFResult>("/models/boss-transformed.glb", { useDraco: "/" }));
