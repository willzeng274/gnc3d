<script lang="ts">
	...
	import { death, freeze, playerAnimation, playerLinvel, playerPos, playerRotation, score, socket, gameConfig, azure, startGameBool } from "$lib/store";
	...
	setContext('assetItems',assetItemsObj());
</script>
