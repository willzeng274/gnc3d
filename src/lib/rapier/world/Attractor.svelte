<script lang="ts">
	...
	type GravityType = "static" | "linear" | "newtonian" | "reverseLinear" | "reverseCubic" | "sqrtNewtonian";
	...
	const calcForceByType = {
		...
		reverseCubic: (s: number, m2: number, r: number, d: number, G: number) => s * 1 / Math.cbrt(d),
	};
